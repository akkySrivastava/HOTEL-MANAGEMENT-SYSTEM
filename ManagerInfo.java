...
public class ManagerInfo extends JFrame implements ActionListener{
    ...
    ManagerInfo()
    {
        ...
        setLocation(350,200);
        //SsetDefaultCloseOperation(EXIT_ON_CLOSE);
        setSize(1000,380);
        setLayout(null);
        
        l=new JLabel("MANAGER DETAILS");
        ...
        try{
                ...
                ResultSet rs=conn.s.executeQuery("select * from employeedetails where job='Manager'");
                while(rs.next())
                {
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b2)
        {
            ...
            String s=JOptionPane.showInputDialog(null,"Enter the employee id of Manager to delete:");
